...
WORKPATH="/home/saraghava/GenAIExamples/HybridRag"
...
function build_docker_images() {
    ...
    mkdir -p $WORKPATH/docker_image_build
    ...
    service_list="text2cypher struct2graph dataprep vllm"
    docker compose -f $WORKPATH/docker_image_build/build.yaml build ${service_list} --no-cache > ${LOG_PATH}/docker_image_build.log
...
function start_services() {
    ...
    docker compose -f mycompose.yaml up -d > ${LOG_PATH}/start_services_with_compose.log
